...
translations = {
        ...
        'Ошибка: недостаточно памяти CUDA. Освобождаем память. Попробуйте уменьшить разрешение изображения или включите режим SAHI...': 
            'Error: Not enough CUDA memory. Freeing up memory. Please try reducing the image resolution or enable SAHI mode...',
    ...
    "zh-cn": {
        ...
        'Ошибка: недостаточно памяти CUDA. Освобождаем память. Попробуйте уменьшить разрешение изображения или включите режим SAHI...': 
            '错误：CUDA内存不足。正在释放内存。请尝试降低图像分辨率或启用SAHI模式...',
    ...
    "zh-tw": {
        ...
        'Ошибка: недостаточно памяти CUDA. Освобождаем память. Попробуйте уменьшить разрешение изображения или включите режим SAHI...': 
            '錯誤：CUDA記憶體不足。正在釋放記憶體。請嘗試降低圖像解析度或啟用SAHI模式...',
...
translations_i18n = {
        ...
        'Модель обнаружения': 'Detection model',
        'Включить': 'Enable',
        'Включить режим анализа отдельных частиц (SAHI)?': 'Enable tiled processing (SAHI)?',
        'Высота слайса': 'Slice height',
        'Ширина слайса': 'Slice width',
        'Перекрытие по высоте': 'Height overlap ratio',
        'Перекрытие по ширине': 'Width overlap ratio',
    ...
    "ru": { 
        ...
        'Модель обнаружения': 'Модель обнаружения', 
        'Включить': 'Включить', 
        'Включить режим анализа отдельных частиц (SAHI)?': 'Включить режим анализа отдельных частиц (SAHI)?', 
        'Высота слайса': 'Высота слайса', 
        'Ширина слайса': 'Ширина слайса', 
        'Перекрытие по высоте': 'Перекрытие по высоте', 
        'Перекрытие по ширине': 'Перекрытие по ширине', 
    ...
    "zh-cn": {
        ...
        'Модель обнаружения': '检测模型',
        'Включить': '启用',
        'Включить режим анализа отдельных частиц (SAHI)?': '启用分块处理(SAHI)?',
        'Высота слайса': '切片高度',
        'Ширина слайса': '切片宽度',
        'Перекрытие по высоте': '高度重叠率',
        'Перекрытие по ширине': '宽度重叠率',
    ...
    "zh-tw": {
        ...
        'Модель обнаружения': '檢測模型',
        'Включить': '啟用',
        'Включить режим анализа отдельных частиц (SAHI)?': '啟用分塊處理(SAHI)?',
        'Высота слайса': '切片高度',
        'Ширина слайса': '切片寬度',
        'Перекрытие по высоте': '高度重疊率',
        'Перекрытие по ширине': '寬度重疊率',
