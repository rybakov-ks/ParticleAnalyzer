...
translations = {
        ...
        'Ошибка: недостаточно памяти CUDA. Освобождаем память. Попробуйте снова или уменьшите разрешение изображения...': 
            'Error: Not enough CUDA memory. Freeing memory. Please try again or reduce image resolution...',
        ...
        'Достигнут предел количества обнаружений. Увеличьте максимальное количество обнаружений в настройках.': 
            'Detection limit reached. Increase maximum detections in settings.',
        ...
        'D [пикс]': 'D [px]',
        'I [ед.]': 'I [units]',
        'Detectron2 обрабатывает изображения...': 'Detectron2 is processing images...',
        ...
        ('Распределение площади', 'Распределение периметра', 'Распределение диаметра', 'Распределение эксцентриситета', 'Распределение интенсивности'): 
            ('Area distribution', 'Perimeter distribution', 'Diameter distribution', 'Eccentricity distribution', 'Intensity distribution'),
        ...
        'Обозначьте на изображении масштабную шкалу при помощи двух точек.': 
            'Please mark the scale bar on the image using two points.',
        'Тёмный режим': 'Dark mode',
        'Светлый режим': 'Light mode',
        'ParticleAnalyzer — Инструмент для анализа изображений SEM': 
            'ParticleAnalyzer — SEM Image Analysis Tool',
        'При помощи данного инструмента можно анализировать размерные характеристики частиц на изображениях SEM.': 
            'This tool allows you to analyze particle size characteristics in SEM images.',
        'Анализ': 'Analysis',
        ...
        'Включить': 'Enable',
        'Включить обработку с разбиением на фрагменты?': 'Enable tiled processing?',
        ...
        ('Pixels', 'Instrument scale in µm'): ('Pixels', 'Instrument scale in µm'),
        'Разрешение изображения': 'Image resolution',
        ('Original', '640x640', '1024x1024'): ('Original', '640x640', '1024x1024'),
    ...
    "ru": {
        ...
        'Ошибка: недостаточно памяти CUDA. Освобождаем память. Попробуйте снова или уменьшите разрешение изображения...': 'Ошибка: недостаточно памяти CUDA. Освобождаем память. Попробуйте снова или уменьшите разрешение изображения...',
        ...
        'D [пикс]': 'D [пикс]', 
        'I [ед.]': 'I [ед.]', 
        'Detectron2 обрабатывает изображения...': 'Detectron2 обрабатывает изображения...', 
        ...
        ('Распределение площади', 'Распределение периметра', 'Распределение диаметра', 'Распределение эксцентриситета', 'Распределение интенсивности'): ('Распределение площади', 'Распределение периметра', 'Распределение диаметра', 'Распределение эксцентриситета', 'Распределение интенсивности'), 
        ...
        'Включить': 'Включить', 
        'Включить обработку с разбиением на фрагменты?': 'Включить обработку с разбиением на фрагменты?', 
    ...
    "zh-cn": {
        ...
        'D [пикс]': 'D [像素]',
        'I [ед.]': 'I [单位]',
        'Detectron2 обрабатывает изображения...': 'Detectron2正在处理图像...',
        ...
        'Включить': '启用',
        'Включить обработку с разбиением на фрагменты?': '启用分块处理?',
        'Высота слайса': '切片高度',
        'Ширина слайса': '切片宽度',
    ...
    "zh-tw": {
        ...
        'D [пикс]': 'D [像素]',
        'I [ед.]': 'I [單位]',
        'Detectron2 обрабатывает изображения...': 'Detectron2正在處理圖像...',
        ...
        'Включить': '啟用',
        'Включить обработку с разбиением на фрагменты?': '啟用分塊處理?',
        'Высота слайса': '切片高度',
        'Ширина слайса': '切片寬度',
...
i18n = gr.I18n(
    ru=translations_i18n['ru'],
    en=translations_i18n['en'],
    **{
        'zh-CN': translations_i18n['zh-cn'],
        'zh-TW': translations_i18n['zh-tw']
    }
)