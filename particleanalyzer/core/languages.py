...
translations = {
    'en': {
        ...
        'При помощи данного инструмента можно анализировать размерные характеристики частиц на изображениях SEM.<br>В случае проблем с сегментацией изображения или возникновения ошибок, пожалуйста, направляйте материалы на электронную почту: rybakov-ks@ya.ru':
            'This tool can be used to analyze particle size characteristics in SEM images.<br>In case of problems with image segmentation or errors, please send materials to e-mail: rybakov-ks@ya.ru',
        'Анализ': 'Analysis',
        ...
        'Dₘᵢₙ [мкм]': 'Dₘᵢₙ [µm]',
        'Dₘₑₐₙ [мкм]': 'Dₘₑₐₙ [µm]',
        'Dₘₐₓ [пикс]': 'Dₘₐₓ [pixels]',
        'Dₘᵢₙ [пикс]': 'Dₘᵢₙ [pixels]',
        'Dₘₑₐₙ [пикс]': 'Dₘₑₐₙ [pixels]',
        'θₘₐₓ [°]': 'θₘₐₓ [°]',
        'θₘᵢₙ [°]': 'θₘᵢₙ [°]',  
        ...
        'Средний диаметр [пикс]': 'Average diameter [pixels]',
        'Максимальный диаметр [пикс]': 'Maximum diameter [pixels]',
        'Минимальный диаметр [пикс]': 'Minimum diameter [pixels]',
    ...
    'zh-cn': {
        ...
        'При помощи данного инструмента можно анализировать размерные характеристики частиц на изображениях SEM.<br>В случае проблем с сегментацией изображения или возникновения ошибок, пожалуйста, направляйте материалы на электронную почту: rybakov-ks@ya.ru': 
            '该工具可用于分析SEM图像中的粒度特征。<br>如遇图像分割问题或错误，请将资料发送至邮箱：rybakov-ks@ya.ru',
        'Анализ': '分析',
    ...
    'zh-tw': {
        ...
        'При помощи данного инструмента можно анализировать размерные характеристики частиц на изображениях SEM.<br>В случае проблем с сегментацией изображения или возникновения ошибок, пожалуйста, направляйте материалы на электронную почту: rybakov-ks@ya.ru': 
            '此工具可用於分析SEM影像中的粒度特徵。 <br>如遇影像分割問題或錯誤，請將資料寄至信箱：rybakov-ks@ya.ru',
        'Анализ': '分析',
