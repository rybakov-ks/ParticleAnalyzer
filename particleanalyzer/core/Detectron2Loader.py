...
class Detectron2Loader:
    def __init__(self, device=None):
        ...
        self.config_paths = {
            ...
            "Cascade_X152": self.model_path("cascade_mask_rcnn_X_152_32x8d_FPN_IN5k_gn_dconv.yaml")
        }
        ...
        self.model_paths = {
            ...
            "Cascade_X152": self.model_path("cascade_mask_rcnn_X_152_32x8d_FPN_IN5k_gn_dconv.pth")
        }
